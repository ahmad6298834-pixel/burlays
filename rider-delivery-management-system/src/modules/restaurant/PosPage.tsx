    ...
    <div>
      ...
      {savedId && (
        <Card className="mb-4 border-emerald-200 bg-emerald-50">
          <p className="font-semibold text-emerald-800">Order {orderNumber} saved successfully.</p>
          <div className="mt-3 flex flex-wrap gap-2">
            <Button onClick={() => router.push(`/restaurant/orders/${savedId}/receipt`)}>
              🧾 Print Customer Receipt
            </Button>
            <Button variant="secondary" onClick={() => router.push(`/restaurant/orders/${savedId}/kitchen`)}>
              👨‍🍳 Print Kitchen Ticket
            </Button>
            <Button variant="secondary" onClick={startNewOrder}>
              + New Order
            </Button>
          </div>
        </Card>
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <Button className="mt-4 w-full" onClick={save} disabled={saving || cart.length === 0 || Boolean(savedId)}>
              {saving ? "Saving..." : savedId ? "Order Saved" : "💾 Save Order"}
            </Button>
          </Card>
        </div>
      </div>
